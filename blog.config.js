...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.notion.site/api/v3', // API默认请求地址 ,可配置成自己的 https://<xxxx>.notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Scott Shih', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Musician and Physician', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cmuhdnr.vercel.app', // 网站地址
